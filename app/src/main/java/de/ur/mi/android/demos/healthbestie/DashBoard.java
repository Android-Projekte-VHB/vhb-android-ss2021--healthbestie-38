...
import de.ur.mi.android.demos.healthbestie.drawer_menu_fragments.FeedbackFragment;
import de.ur.mi.android.demos.healthbestie.drawer_menu_fragments.HomeFragment;
import de.ur.mi.android.demos.healthbestie.drawer_menu_fragments.PolicyFragment;
import de.ur.mi.android.demos.healthbestie.drawer_menu_fragments.profile.ProfileFragment;
import de.ur.mi.android.demos.healthbestie.drawer_menu_fragments.SettingsFragment;
...
public class DashBoard extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    private void setBiometricAuth() {
        ...
        if (biometricAuth.checkCompatibility(this) == true) {
            biometricAuth.setBiometricPrompt(DashBoard.this);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.logout:
                ...
                Intent backToLogin = new Intent(DashBoard.this, Login.class);
